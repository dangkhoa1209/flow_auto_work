/**
 * Job domain service — framework-agnostic business logic.
 * Controllers call these; no Express/Hono imports here.
 */
import { listPendingClarifications } from "../clarify/ui-wait.js";
...
import { listPendingDiffApprovals } from "../review/diff-wait.js";
